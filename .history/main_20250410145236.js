...
//   });
domtoimage
  .toPng(document.querySelector('.background-box'), {
    quality: 1, // Tăng chất lượng
    height: elementToCapture.offsetHeight * 3, // scale thủ công
    width: elementToCapture.offsetWidth * 3,
    style: {
      transform: 'scale(3)',
