  ...
  document.getElementById("btn-download").addEventListener("click", () => {
    ...
    // Kích thước ảnh lớn (theo ảnh gốc)
    ...
    background.onload = () => {
      ...
      // Tính vị trí tương ứng trong ảnh lớn (tùy bạn đo hoặc điều chỉnh)
      const positions = [
        { x: 870, y: 980 },
        { x: 1590, y: 980 },
        { x: 870, y: 1950 },
      ...
      imgElements.forEach((img, index) => {
        ...
        image.onload = () => {
          ...
          ctx.drawImage(image, pos.x, pos.y, 570, 450); // 190x150 tương ứng x3
          loaded++;
